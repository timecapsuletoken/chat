...
import { FaPowerOff, FaWallet, FaCogs, FaInfoCircle, FaQuestionCircle, FaTimes } from 'react-icons/fa';
      ...
      <div className="sidebar">
        <div className="wallet-header">
          ...
          <div className="wallet-controls">
            ...
            <a className="homebtn" href="/home"><MdHome /></a>
            ...
            <button onClick={toggleDropdown}><MdFormatListBulleted /></button>
              {showDropdown && (
